      ...
      <div className="container">
        <div>
          ...
          <p className="text-center mt-6 text-sm md:mx-20 uppercase">
            Meta Ninja STRIVES TO CREATE A METAVERSE WORLD FOR ITS INU ARMY,
        ...
        <div className=" grid grid-cols-1 gap-y-10 lg:gap-y-0 lg:grid-cols-2 gap-4 items-center mt-16">
          ...
          >
            <p className="text-sm capitalize font-normal mt-6 text-dark-300">
              Bringing the community together in one engaging and immersive
              metaverse ecosystem, aka Meta Ninjaverse. A play to earn Inu
              gaming metaverse is currently being formed by the Meta Ninja team,
              which has partnered up with a well-known gaming company that has
              nine years of gaming development experience.
            </p>
            <p className="text-sm capitalize font-normal mt-6 text-dark-300">
              One of our partners has even received a variety of international
              gaming awards! The team’s next gaming venture is Meta Ninjaverse,
              making Meta Ninja story come to life. In Meta Ninjaverse, known
            ...
            <p className="text-sm capitalize font-normal mt-6 text-dark-300">
              ...
              missions. Meta Ninjaverse will be an open-world fantasy game that
        ...
        <p className="text-sm capitalize  font-normal mt-10 text-dark-300">
          ...
          an open-world exploration game. Meta Ninjaverse will be implementing
          ...
          galleries, displaying Meta Ninja NFT’s. These NFTs will be developed
          by various NFT artists, and the talent of the Meta Ninja community.
        </p>
      </div>
    </div>
  );
